...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"            -work u_rx_phy_rst_ctrl
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"                  -work u_rx_phy_rst_ctrl
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv"        -work u_rx_phy_rst_ctrl
  vlogan +v2k -sverilog "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"           -work u_rx_phy_rst_ctrl
  ...
  vhdlan -xlrm          "$QSYS_SIMDIR/sdi_ii/sdi_ii_0001.vhd"                                        -work sdi_ip_ii_rx     
  vhdlan -xlrm          "$QSYS_SIMDIR/sdi_ip_ii_rx.vhd"                                                                     
fi
