...
# ACDS 15.0 145 win32 2023.10.02.09:44:30
...
alias com {
  echo "\[exec\] com"
  vlog     "$QSYS_SIMDIR/altera_reset_controller/mentor/altera_reset_controller.v"             -work tx_rst_coreclk_sync
  vlog     "$QSYS_SIMDIR/altera_reset_controller/mentor/altera_reset_synchronizer.v"           -work tx_rst_coreclk_sync
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_phy_mgmt/mentor/src_hdl/sdi_ii_tx_phy_mgmt.v"               -work u_tx_phy_mgmt      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_phy_mgmt/mentor/src_hdl/sdi_ii_tx_sample.v"                 -work u_tx_phy_mgmt      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_phy_mgmt/mentor/src_hdl/sdi_ii_tx_xcvr_interface.v"         -work u_tx_phy_mgmt      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_phy_mgmt/mentor/src_hdl/sdi_ii_tx_ce_gen.v"                 -work u_tx_phy_mgmt      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_tx_protocol.v"               -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_hd_crc.v"                    -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_hd_insert_ln.v"              -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_scrambler.v"                 -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_transmit.v"                  -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_vpid_insert.v"               -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_trsmatch.v"                  -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_sd_bits_conv.v"              -work u_tx_protocol      
  vlog     "$QSYS_SIMDIR/sdi_ii_tx_protocol/mentor/src_hdl/sdi_ii_sync_bit_ins.v"              -work u_tx_protocol      
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"                   -work u_tx_phy_rst_ctrl  
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/altera_xcvr_functions.sv"            -work u_tx_phy_rst_ctrl  
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"                         -work u_tx_phy_rst_ctrl  
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/alt_xcvr_resync.sv"                  -work u_tx_phy_rst_ctrl  
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv"               -work u_tx_phy_rst_ctrl  
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"                  -work u_tx_phy_rst_ctrl  
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/altera_xcvr_reset_control.sv"        -work u_tx_phy_rst_ctrl  
  vlog -sv "$QSYS_SIMDIR/altera_xcvr_reset_control/mentor/alt_xcvr_reset_counter.sv"           -work u_tx_phy_rst_ctrl  
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L tx_rst_coreclk_sync -L u_tx_phy_mgmt -L u_tx_protocol -L u_tx_phy_rst_ctrl -L u_phy -L u_phy_adapter -L sdi_ip_ii_tx -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L tx_rst_coreclk_sync -L u_tx_phy_mgmt -L u_tx_protocol -L u_tx_phy_rst_ctrl -L u_phy -L u_phy_adapter -L sdi_ip_ii_tx -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
